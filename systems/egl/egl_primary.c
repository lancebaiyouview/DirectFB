...
D_DEBUG_DOMAIN( EGL_Update, "EGL/Update", "EGL Update" );
                   ...
                   DFBScreenDescription *description )
{
     ...
     /* Set the screen name. */
     snprintf( description->name, DFB_SCREEN_DESC_NAME_LENGTH, "EGL Primary Screen" );
...
static const ScreenFuncs _eglPrimaryScreenFuncs = {
...
const ScreenFuncs *eglPrimaryScreenFuncs = &_eglPrimaryScreenFuncs;
                  ...
                  DFBColorAdjustment         *adjustment )
{
     ...
     snprintf( description->name,
               DFB_DISPLAY_LAYER_DESC_NAME_LENGTH, "EGL Primary Layer" );
...
static DFBResult
DisplaySurface( EGLData    *egl,
                void       *handle )
{
//     EGLERROR eEGLStatus;
//     eEGLStatus = EGLPresentBlt( egl->hEGLContext, meminfo, 0 );
//     if (eEGLStatus) {
//          D_ERROR( "DirectFB/EGL: EGLPresentBlt() failed! (status %d)\n", eEGLStatus );
//          return DFB_FAILURE;
//     }
     return DFB_OK;
}
...
static const DisplayLayerFuncs _eglPrimaryLayerFuncs = {
...
const DisplayLayerFuncs *eglPrimaryLayerFuncs = &_eglPrimaryLayerFuncs;
